...
long taumBday(int b, int w, int bc, int wc, int z) {
    // Effective cost of black gift
    long long effective_bc = min((long long)bc, (long long)wc + z);
    // Effective cost of white gift
    long long effective_wc = min((long long)wc, (long long)bc + z);
